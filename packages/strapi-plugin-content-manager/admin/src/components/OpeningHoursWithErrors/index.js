...
class OpeningHoursWithErrors extends React.Component {
...
OpeningHoursWithErrors.defaultProps = {
  autoFocus: false,
  className: '',
...
OpeningHoursWithErrors.propTypes = {
...
export default OpeningHoursWithErrors;
